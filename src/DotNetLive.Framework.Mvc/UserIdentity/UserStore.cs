...
using DotNetLive.Framework.Web.UserIdentity.Models;
...
namespace DotNetLive.Framework.Mvc.UserIdentity
{
        ...
        where TUser : ApplicationUser
    {
        ...
        public async Task<IdentityResult> CreateAsync(TUser user, CancellationToken cancellationToken)
        {
            ...
            ApiResponse<Guid> rsp = _userApiClient.Create(account);

            return await Task.FromResult(rsp.Success ? IdentityResult.Success : IdentityResult.Failed(new IdentityError()
            {
                Code = rsp.ApiMessage.ErrorCode,
                Description = rsp.ApiMessage.ErrorMessage
            }));
        }
        ...
        public async Task<IdentityResult> DeleteAsync(TUser user, CancellationToken cancellationToken)
        {
            ...
            ApiResponse rsp = _userApiClient.Update(_mapper.Map<ApplicationUser, Account>(user));
        ...
        public Task<TUser> FindByIdAsync(string userId, CancellationToken cancellationToken)
        {
            ...
            ApiResponse<Account> rsp = _userApiClient.GetAccount(Guid.Parse(userId));
            var user = _mapper.Map<Account, ApplicationUser>(rsp.ResponseResult) as TUser;
        ...
        public Task<TUser> FindByNameAsync(string normalizedUserEmail, CancellationToken cancellationToken)
        {
            ...
            ApiResponse<Account> rsp = _userApiClient.GetAccountByNormalizedEmail(normalizedUserEmail);
            var user = _mapper.Map<Account, ApplicationUser>(rsp.ResponseResult) as TUser;
            return Task.FromResult(user);
        }
        ...
        public async Task<IdentityResult> UpdateAsync(TUser user, CancellationToken cancellationToken)
        {
            ...
            ApiResponse rsp = _userApiClient.Update(account);
        ...
        public Task<TUser> FindByEmailAsync(string normalizedEmail, CancellationToken cancellationToken)
        {
            ...
            ApiResponse<Account> rsp = _userApiClient.GetAccountByNormalizedEmail(normalizedEmail);
            var user = _mapper.Map<Account, ApplicationUser>(rsp.ResponseResult) as TUser;
            return Task.FromResult(user);
        }
